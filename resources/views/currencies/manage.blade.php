  ...
  <div class="bg-[var(--c-surface)] rounded-2xl border border-[var(--c-border)] p-6">
    <div class="mb-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
        <input type="text" id="search-currencies" placeholder="Buscar monedas..." class="w-full px-3 py-2 bg-[var(--c-elev)] border border-[var(--c-border)] rounded-lg text-sm sm:w-72">
    ...
    <!-- Pagination -->
    <div id="currencies-pagination" class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
